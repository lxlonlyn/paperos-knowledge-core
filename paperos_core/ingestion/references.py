...
def parse_reference_entry(
    *,
    ...
    from paperos_core.ingestion.citations import extract_reference_label
    ...
    index_match = _INDEX.match(normalized)
    citation_label, label_kind = extract_reference_label(normalized)
    return ReferenceEntry(
        ...
        parsed_fields={
            "reference_number": (
                ...
                if index_match and index_match.group(1).isdigit()
                else None
            ),
            "citation_label": citation_label,
